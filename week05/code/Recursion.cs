...
public static class Recursion
{
    ...
    public static int SumSquaresRecursive(int n)
    {
        ...
        // Recursive case: n squared + sum of all previous squares
    ...
    public static void PermutationsChoose(List<string> results, string letters, int size, string word = "")
    {
        ...
        // Recursive case: try each letter in the remaining letters
        for (int i = 0; i < letters.Length; i++)
        {
            // Take one letter
            char currentLetter = letters[i];

            // Remove that letter from the available letters
            string remainingLetters = letters.Remove(i, 1);

            // Recurse with the current letter added to word
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        // Base case: if no wildcard found, add pattern to results
        if (wildcardIndex == -1)
        {
            results.Add(pattern);
            return;
        ...
        // Recursive case: replace wildcard with '0' and recurse
